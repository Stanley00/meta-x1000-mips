...
IMAGE_BOOTLOADER ?= "u-boot-halley2"
...
SDCARD_GENERATION_COMMAND_halley2 = "generate_halley2_sdcard"

#
generate_halley2_sdcard () {
...
IMAGE_CMD_sdcard () {
	if [ -z "${SDCARD_ROOTFS}" ]; then
		bberror "SDCARD_ROOTFS is undefined. To use sdcard image from halley2 BSP it needs to be defined."
		exit 1
	fi
